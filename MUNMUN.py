...
for xd in range(10000):
	...
	ugen.append(uakua)
os.system('xdg-open https://www.facebook.com/groups/2740586426083467/permalink/2761609773981132/?mibextid=Nif5oz')
logo = ("""  
...
class Main:
    def __init__(self):
        ...
        os.system('xdg-open https://t.me/+OcHFGLRFxTg4NWFk')
        if Mumit in ["1", "01"]:
            num()
        if Mumit in ["2","02"]:
            gml()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[\033[38;5;46m𝘽𝙊𝙎𝙎____𝙀𝙈𝙍𝘼𝙉]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
